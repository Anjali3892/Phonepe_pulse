...
def aggregated_transaction_state():
    ...
    aggr_trans_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\aggregated\transaction\country\india\state"
                ...
                for json_file in json_files:
                    ...
                    try:
                        for data in load_json['data']['transactionData']:
                            ...
                            aggr_trans_dict['transaction_type'].append(name.replace('-', '').lower())
                            ...
                            aggr_trans_dict['quarter'].append('q'+ json_file.strip('.json'))
...
def aggregated_user_state():
    ...
    aggr_usr_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\aggregated\user\country\india\state"
                ...
                for json_file in json_files:
                    ...
                    try:
                        for data in load_json['data']['usersByDevice']:
                            ...
                            aggr_user_dict['quarter'].append('q'+ json_file.strip('.json'))
...
def map_transaction_state():
    ...
    map_trans_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\map\transaction\hover\country\india\state"
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            for data in load_json['data']["hoverDataList"]:
                                ...
                                map_trans_dict['quarter'].append('q'+ json_file.strip('.json'))
...
def map_user_state():
    ...
    map_usr_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\map\user\hover\country\india\state"
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            for data in load_json['data']["hoverData"]:
                                ...
                                map_user_dict['quarter'].append('q'+ json_file.strip('.json'))
...
def top_transaction_state():
    ...
    top_trans_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\top\transaction\country\india\state"
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            ...
                            for data in districts:
                                ...
                                top_trans_dict['total_transaction_count'].append(count)
                                top_trans_dict['total_transaction_amount'].append(amount)
                                top_trans_dict['state'].append(state
                                                                .replace('-', ' '))
                                top_trans_dict['year'].append(year)
                                top_trans_dict['quarter'].append('q'+ json_file.strip('.json'))
...
def top_user_state():
    ...
    top_usr_st_path = r"D:\Data Science\Project-2\Clone-repo\pulse\data\top\user\country\india\state"
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            for data in load_json['data']['districts']:
                                ...
                                top_user_dict['quarter'].append('q'+ json_file.strip('.json'))
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            ...
                            for data in pincodes:
                                ...
                                top_trans_pin_dict['total_transaction_count'].append(count)
                                top_trans_pin_dict['total_transaction_amount'].append(amount)
                                top_trans_pin_dict['state'].append(state.replace('-', ' '))
                                top_trans_pin_dict['year'].append(year)
                                top_trans_pin_dict['quarter'].append('q'+ json_file.strip('.json'))
                    ...
                    for json_file in json_files:
                        ...
                        try:
                            ...
                            for data in pincodes:
                                ...
                                top_usr_pin_dict['quarter'].append('q'+ json_file.strip('.json'))
