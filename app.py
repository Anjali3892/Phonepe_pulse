...
header_style = '''
            ...
            .navbar-brand span {
             ...
             <nav class="navbar">
                ...
                <img src="file:///D:\Data_Science\Project-2\pelogo.PNG" width="400" height="200" alt="">
...
with data_column:
    ...
    if options == 'Transactions':
        if year == year:
            if quarter == quarter:
                st.markdown('<h1 style="color: #05c3de; font-size: 37px;">Transactions</h1>', unsafe_allow_html=True)
                
                c1='<span style="color: #e9dff4;font-size: 18px; font-weight: bold;">All PhonePe transactions (UPI + Cards + Wallets)</span>'
                ...
                colored1 = f'<span style="color: #05c3de;font-size: 30px; font-weight: bold;">{all_trans}</span>'
                ...
                with col8:
                    ...
                    c2='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Total payment value</span>'
                    ...
                    colored2 = f'<span style="color: #05c3de;font-size: 23px; font-weight: bold;">{total_payment}</span>'
                    st.markdown(colored2, unsafe_allow_html=True)
                with col9:
                    c3='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Avg. transaction value</span>'
                    ...
                    colored3 = f'<span style="color: #05c3de;font-size: 23px; font-weight: bold;">{avg_trans}</span>'
                    st.markdown(colored3, unsafe_allow_html=True)
                
                col10, col11 = st.columns([12,12])
                    
                with col10:
                    st.markdown('<h1 style="color: #05c3de; font-size: 37px;">Categories </h1>', unsafe_allow_html=True)
                    c4='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Recharge & bill payments</span>'
                    st.markdown(c4,unsafe_allow_html=True)
                    
                    c5='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Peer-to-peer payments</span>'
                    st.markdown(c5,unsafe_allow_html=True)
                    
                    c6='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Merchant payments</span>'
                    st.markdown(c6,unsafe_allow_html=True)
                    
                    c7='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Financial Services</span>'
                    st.markdown(c7,unsafe_allow_html=True)
                    
                    c8='<span style="color: #e9dff4;font-size: 16px;font-weight: bold;">Others</span>'
                ...
                with col11:
                    ...
                    colored4 = f'<span style="color: #05c3de;font-size: 17px; font-weight: bold;">{recharge}</span>'
                    ...
                    colored5 = f'<span style="color: #05c3de;font-size: 17px; font-weight: bold;">{peer}</span>'
                    ...
                    colored6 = f'<span style="color: #05c3de;font-size: 17px; font-weight: bold;">{merchant}</span>'
                    ...
                    colored7 = f'<span style="color: #05c3de;font-size: 17px; font-weight: bold;">{financial}</span>'
                    ...
                    colored8 = f'<span style="color: #05c3de;font-size: 17px; font-weight: bold;">{others}</span>'
                ...
                with tab1:
                    st.markdown('<h1 style="color: #05c3de; font-size: 25px;">Top 10 states</h1>', unsafe_allow_html=True)
                    col12, col13 = st.columns([8,14])
                    
                    with col12:
                        for rows in transactions_top_state(year, quarter)['State']:
                            state = rows.capitalize()    
                            s1=f'<span style="color: #ffffff;font-size: 15px; ">{state}</span>'                                                
                    ...
                    with col13:
                        for rows in transactions_top_state(year, quarter)['Total transaction count']:
                            if rows >= 10000000:
                                ...
                                colored9 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                ...
                with tab2:
                    st.markdown('<h1 style="color: #05c3de; font-size: 25px;">Top 10 districts</h1>', unsafe_allow_html=True)
                    col14, col15 = st.columns([8,14])
                    
                    with col14:
                        for rows in transactions_top_district(year, quarter)['District']:
                            district = rows.capitalize()
                            d1=f'<span style="color: #ffffff;font-size: 15px; ">{district}</span>'                                                
                    ...
                    with col15:
                        for rows in transactions_top_district(year, quarter)['Total transaction count']:
                            if rows >= 10000000:
                                formatted_value = locale.format_string('%.2fCr', rows / 10000000, grouping=True)
                                colored10 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                ...
                with tab3:
                    st.markdown('<h1 style="color: #05c3de; font-size: 25px;">Top 10 pincodes</h1>', unsafe_allow_html=True)
                    col16, col17 = st.columns([8,14])
                    
                    with col16:
                        for rows in transactions_top_pincode(year, quarter)['Pincode']:
                            p1=f'<span style="color: #ffffff;font-size: 15px; ">{rows}</span>'                                                
                            st.markdown(p1, unsafe_allow_html=True)
                    with col17:
                        for rows in transactions_top_pincode(year, quarter)['Total transaction count']:
                            if rows >= 10000000:
                                formatted_value = locale.format_string('%.2fCr', rows / 10000000, grouping=True)
                                colored11 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored11, unsafe_allow_html=True)
                            else:
                                formatted_value = locale.format_string('%.2fL', rows / 100000, grouping=True)
                                colored12 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored12, unsafe_allow_html=True)
            
    elif options == 'Users':
        if year == year:
            if quarter == quarter:
                st.markdown('<h1 style="color: #05c3de; font-size: 37px;">Users</h1>', unsafe_allow_html=True)
                u1='<span style="color: #e9dff4;font-size: 18px; font-weight: bold;">Registered PhonePe users till</span>'
                st.markdown(u1,unsafe_allow_html=True)
                ...
                colored13 = f'<span style="color: #05c3de;font-size: 23px; font-weight: bold;">{reg_usr}</span>'
                st.markdown(colored13, unsafe_allow_html=True)
                
                #st.write(f'PhonePe app opens in {quarter} {year}')
                u2='<span style="color: #e9dff4;font-size: 18px; font-weight: bold;">PhonePe app opens</span>'
                st.markdown(u2,unsafe_allow_html=True)
                reg_usr = users(year, quarter)['PhonePe app opens'].apply(lambda x: locale.format_string('%d', x, grouping=True)).values[0]
                colored15 = f'<span style="color: #05c3de;font-size: 23px; font-weight: bold;">{reg_usr}</span>'
                ...
                with tab4:
                    ...
                    with col19:
                        for rows in users_top_state(year, quarter)['Total registered users']:
                            if rows >= 10000000:
                                formatted_value = locale.format_string('%.2fCr', rows / 10000000, grouping=True)
                                colored16 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored16, unsafe_allow_html=True)
                            else:
                                formatted_value = locale.format_string('%.2fL', rows / 100000, grouping=True)
                                colored17 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                ...
                with tab5:
                    ...
                    with col20:
                        for rows in users_top_district(year, quarter)['District']:
                            district = rows.capitalize()
                            d2=f'<span style="color: #ffffff;font-size: 15px; ">{district}</span>'                                                
                    ...
                    with col21:
                        for rows in users_top_district(year, quarter)['Total registered users']:
                            if rows >= 10000000:
                                formatted_value = locale.format_string('%.2fCr', rows / 10000000, grouping=True)
                                colored18 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored18, unsafe_allow_html=True)
                            else:
                                formatted_value = locale.format_string('%.2fL', rows / 100000, grouping=True)
                                colored19 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                ...
                with tab6:
                    ...
                    with col22:
                        for rows in users_top_pincode(year, quarter)['Pincode']:
                            p2=f'<span style="color: #ffffff;font-size: 15px; ">{rows}</span>'                                                
                    ...
                    with col23:
                        for rows in users_top_pincode(year, quarter)['Total registered users']:
                            if rows >= 10000000:
                                formatted_value = locale.format_string('%.2fCr', rows / 10000000, grouping=True)
                                colored20 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored20, unsafe_allow_html=True)
                            else:
                                formatted_value = locale.format_string('%.2fL', rows / 100000, grouping=True)
                                colored21 = f'<span style="color: #05c3de;font-size: 16px; font-weight: bold;">{formatted_value}</span>'
                                st.markdown(colored21, unsafe_allow_html=True)

with map_column:
    transactions = pd.read_csv(r'D:\Data_Science\Project-2\CSV\map_transaction_state1.csv')
    users = pd.read_csv(r'D:\Data_Science\Project-2\CSV\geo_users.csv')
    ...
    if options == 'Transactions':
        if year == year:
            if quarter == quarter:
                ...
                transactions['State'] = transactions['State'].str.replace('Andaman and Nicobar Islands', 'Andaman & Nicobar')
                
                figure1 = plt.choropleth(data_frame=filtered_transactions,
                ...
                figure1.update_geos(fitbounds = "geojson",visible=False)
                figure1.update_layout(margin={'r': 0, 't': 0, 'l': 0, 'b': 0})
                figure1.update_layout(width=500, height=750)
